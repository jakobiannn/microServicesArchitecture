...
import stats.stats_server as stat
import server.proxy.proxy as pr
import xmlrpc.client
import client.logs_dao as logs_dao
...
if __name__ == "__main__":
    ...
    #
    # serv.server.server_close()
    # pr.server.server_close()
    # stat.server.server_close()
